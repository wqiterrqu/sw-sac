...
SEED = args.seed
ml1 = metaworld.ML1(args.env_name, seed=SEED)
...
for i_episode in itertools.count(1):
    ...
    print("Episode: {}, total_sternums: {}, episode steps: {}, reward: {}".format(i_episode, total_numsteps,
                                                                                  episode_steps,
    ...
    if i_episode % args.eval_interval == 0 and args.eval is True:
        ...
        print("Total Episodes: {}, success_rate: {}".format(args.eval_episodes, 1.0 * success_runs / args.eval_episodes))
        wandb.log(
            data={
                'data/success_rates': 1.0 * success_runs / args.eval_episodes,
            },
            step=total_numsteps
        )
